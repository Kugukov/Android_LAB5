...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    static final LatLng startMarker = new LatLng(52.263266, 76.984637); // Начальный маркер
    ...
    static final LatLng marker3 = new LatLng(52.26254805598668, 76.983311978436); // Дом
    static final LatLng marker4 = new LatLng(52.262258, 76.985367); // Караван
    static final LatLng marker5 = new LatLng(52.26484518739401, 76.98408030696349); // Халык банк
    static final LatLng marker6 = new LatLng(52.263265581463585, 76.97902464808432); // Средняя общеобразовательная школа им. К. Макпалеева
    static final LatLng marker7 = new LatLng(52.265936063597316, 76.98658732977724); // Павлодарский политехнический высший колледж (ППВК)
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker4).title((getString(R.string.marker4_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.caravan)).alpha(ALPHA).
